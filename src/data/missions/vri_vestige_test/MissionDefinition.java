package data.missions.vri_vestige_test;
...
import data.missions.VRI_BaseRandomBattle;
import org.lazywizard.lazylib.MathUtils;

public class MissionDefinition extends VRI_BaseRandomBattle {

    @Override
    public void defineMission(MissionDefinitionAPI api) {
        super.defineMission(api);

        String playerFaction = "mercenary";
        String enemyFaction = "vestige";
        ...
        String playerFleet = "invasion fleet";
        String enemyFleet = "invasion fleet";
